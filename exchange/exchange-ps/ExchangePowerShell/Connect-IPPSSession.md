...
- Security & Compliance PowerShell in Microsoft 365 or Microsoft 365 GCC: Don't use this parameter. The required value is `https://login.microsoftonline.com/organization` or `https://login.microsoftonline.com/common`, but that's also the default value, so you don't need to use this parameter.
- Security & Compliance PowerShell in Office 365 operated by 21Vianet: `https://login.chinacloudapi.cn/organization` or `https://login.chinacloudapi.cn/common`
- Security & Compliance PowerShell in Microsoft GCC High or Microsoft DoD: `https://login.microsoftonline.us/organization` or `https://login.microsoftonline.us/common`
